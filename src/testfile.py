...
DATASET_PATH = '/home/sibo/Documents/Projects/multimodal_sensors/sensor_data/data_txt/'
LIBRARY_PATH = '/home/sibo/Documents/Projects/yael/yael_v438'
...
######################################################
# load model
file_gmm = open('gmm.pkl', 'rb')
gmm = pickle.load(file_gmm)

file_svm = open('svm.pkl', 'rb')
svc = pickle.load(file_svm)

file_mean = open('mean.pkl', 'rb')
mean = pickle.load(file_mean)

file_pca = open('pca.pkl', 'rb')
